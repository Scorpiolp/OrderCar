...
<div class='get'>
    <div class="am-g am-g-fixed"  >
        <form name="contactForm" class="am-form am-form-horizontal" method="post" action="/index.php/Custom/returncar2">
            ...
            <div class="get-title">
                <h1 style="font-size:36px;">Return Car</h1>
                <p>Fill out the form below to Return a car. </p>
            </div>
            ...
            <div class="am-form-group" >
                <button name="submit" type="submit" class="am-btn am-btn-primary">Return Car</button>
            </div>
            <p>&nbsp;</p>
