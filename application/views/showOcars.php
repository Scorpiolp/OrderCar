...
<script type="text/javascript">
    $(document).ready(function(){
        $("[name=sell]").click(function(){
            $.post("/index.php/Manager/sellcar",
                {
                    'license':$(this).attr("lic"),
                },
                function(data){
                    alert("The car sell at the price of $"+data);
                });
        });
    });
</script>
                ...
                <div>
                    <table class="am-table">
                        ...
                        <tr>
                            <td width="50%"></td>
                            <td width="50%">
                                <input lic="<?=$item->license?>" type="button" name="sell" value="Sell it" class="am-btn am-btn-primary am-radius">
                            </td>
                        </tr>
                        <hr>
                    </table>
